...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirectUrl = data.data.role === "admin" ? "/admin" : "/profile";
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-white/5 backdrop-blur-sm border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">เข้าสู่ระบบเพื่อดำเนินการต่อ</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
